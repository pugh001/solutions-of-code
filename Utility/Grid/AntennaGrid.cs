...
public static class AntennaGrid
{
  ...
  /// </summary>
  public static (Point2D<int> antinode1, Point2D<int> antinode2) CalculateAntinodes(Point2D<int> antenna1, Point2D<int> antenna2)
  {
  ...
  /// </summary>
  public static IEnumerable<Point2D<int>> CalculateResonantAntinodes(Point2D<int> antenna1,
  ...
  /// </summary>
  public static HashSet<Point2D<int>> FindAntinodes(List<Point2D<int>> antennas,
    Func<Point2D<int>, bool> isInBounds,
  ...
  /// </summary>
  public static HashSet<Point2D<int>> FindAllAntinodes(Grid grid, bool includeResonant = false, params char[] excludeChars)
  {
