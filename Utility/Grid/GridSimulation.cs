...
public static class GridSimulation
{
  ...
  /// </summary>
  public static (int firstPassRemovals, int totalRemovals) RunSimulation(Grid grid,
  ...
  /// </summary>
  public static TResult RunSimulation<TResult>(Grid grid,
    ...
    char replacementChar = '.')
  {
    ...
    {
      pass++;
      (var positionsToRemove, bool shouldContinue, var passResult) = processPass(grid, pass);
      result = passResult;
  ...
  /// </summary>
  public static Func<Point2D<int>, bool> CreateNeighborCountCondition(Grid grid,
    char targetChar,
    int minNeighbors,
