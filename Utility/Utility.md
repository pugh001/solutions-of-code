...
**ManhattanDistance((int,int), (int,int))** - Calculates Manhattan distance between 2D integer points
**ManhattanDistance((long,long), (long,long))** - Calculates Manhattan distance between 2D long points
