...
public record Rectangle<T> where T : INumber<T>
{
    ...
    {
        MinX = corner1.X < corner2.X ? corner1.X : corner2.X;
        MaxX = corner1.X > corner2.X ? corner1.X : corner2.X;
        MinY = corner1.Y < corner2.Y ? corner1.Y : corner2.Y;
        MaxY = corner1.Y > corner2.Y ? corner1.Y : corner2.Y;
    }
